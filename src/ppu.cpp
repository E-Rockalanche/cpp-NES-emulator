	...
	void clockTick()
	{
		...
		switch ( scanline )
		{
			case 0 ... 239:
				...
				break;
			case 240:
				scanlineCycle<POSTRENDER>();
				break;
			case 241:
				scanlineCycle<VBLANK_LINE>();
				break;
			case 261:
				scanlineCycle<PRERENDER>();
				break;
			default:
				break;
		}
			...
			switch ( cycle )
			{
				...
				case 322 ... 337:
					...
					switch ( cycle % 8 )
					{
						...
						// attribute:
						case 3:
							render_address = attributeAddress();
							break;
						case 4:
						...
						// background
						case 5:
							render_address = backgroundAddress();
							break;
						case 6:
							bg_latch_low = read( render_address );
							break;
						case 7:
							render_address += 8;
							break;
